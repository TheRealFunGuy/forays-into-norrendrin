...
namespace Forays{
	...
	public enum AttrType{UNDEAD,CONSTRUCT,ENHANCED_TORCH,MAGICAL_BLOOD,KEEN_EYES,TOUGH,LOW_LIGHT_VISION,DARKVISION,REGENERATING,STUNNED,PARALYZED,POISONED,IMMOBILIZED,ON_FIRE,CATCHING_FIRE,DETECTING_MONSTERS,FIRE_HIT,COLD_HIT,POISON_HIT,PARALYSIS_HIT,RESIST_SLASH,RESIST_BASH,RESIST_FIRE,RESIST_COLD,RESIST_ELECTRICITY,IMMUNE_FIRE,IMMUNE_COLD,IMMUNE_ARROWS,GLOBAL_FAIL_RATE,COOLDOWN_1,COOLDOWN_2,BLESSED,HOLY_SHIELDED,SPORE_BURST,RESTING,DRIVE_BACK_ON,TUMBLE_ON,DANGER_SENSE_ON,WAR_SHOUTED,HUMANOID_INTELLIGENCE,INVULNERABLE,BOSS_MONSTER,NUM_ATTRS,NO_ATTR};
